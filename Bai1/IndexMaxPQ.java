 ...
 *  is associated with each keythe client
...
public class IndexMaxPQ<Key extends Comparable<Key>> implements Iterable<Integer> {
    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) {
        ...
        Integer[] tmp = {1,3,5,2,4};
        IndexMaxPQ<Integer> pq = new IndexMaxPQ<Integer>(tmp.length);
        for (int i = 0; i < tmp.length; i++) {
            pq.insert(i, tmp[i]);
        }

        // print each key using the iterator
        StdOut.println("Danh sach hang doi uu tien:");
        for (int i : pq) {
            StdOut.println("Chi muc: "+ i + " key: " + tmp[i]);
        }
