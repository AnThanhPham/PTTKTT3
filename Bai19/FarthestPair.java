 ...
 *  
 *  Given n points in the plane, find the farthest pair in n log n time.
 *
...
/**
 *  The {@code FarthestPair} data type computes a farthest pair of points
...
public class FarthestPair {
    ...
    // farthest pair of points and their Euclidean distance
    ...
    private double farthest(Point2D[] pointsByX, Point2D[] pointsByY, Point2D[] aux, int lo, int hi) {
        ...
        // compute farthest pair with both endpoints in left subarray or both in right subarray
        double delta1 = farthest(pointsByX, pointsByY, aux, lo, mid);
        double delta2 = farthest(pointsByX, pointsByY, aux, mid+1, hi);
